                  ...
                  <div className="card-body bg-light">
                    <div className="row">
                      ...
                      <div className="col-6 col-lg-3">
                        ...
                        {/* Text */}
                        <p className="font-size-sm font-weight-bold mb-0">Đã giao hàng</p>
                      </div>
                      <div className="col-6 col-lg-3">
                        {/* Heading */}
                        <h6 className="heading-xxxs text-muted">Tổng tiền:</h6>
                        {/* Text */}
                        <p className="font-size-sm font-weight-bold mb-0">$259.00</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <ul className="list-group list-group-lg list-group-flush-y list-group-flush-x">
                  <li className="list-group-item">
                    <div className="row align-items-center">
                      ...
                      <div className="col">
                        {/* Title */}
                        <p className="font-size-sm font-weight-bold mb-4">
                        ...
                        <div className="card-right-info">
                          <a href="#" className="btn btn-sm btn-block btn-outline-dark">
                            Đỏi trả
                          </a>
                          <a href="#" className="btn btn-sm btn-block btn-outline-dark">
                            Viết review
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-12 col-md-4">
                    {/* Heading */}
                    <p className="font-weight-bold mb-4">Billing Address:</p>
                    <p className="mb-md-0 mb-7 text-gray-500">
                      Daniel Robinson, <br />
                      3997 Raccoon Run, <br />
                      Kingston, 45644, <br />
                      United States, <br />
                  ...
                  <div className="col-12 col-md-4">
                    {/* Heading */}
                    <p className="font-weight-bold mb-4">Shipping Address:</p>
                    <p className="mb-md-0 mb-7 text-gray-500">
                      Daniel Robinson, <br />
                      3997 Raccoon Run, <br />
                      Kingston, 45644, <br />
                  ...
                  <div className="col-12 col-md-4">
                    {/* Heading */}
                    <p className="font-weight-bold mb-4">Shipping Method:</p>
                    <p className="mb-7 text-gray-500">
                      Standart Shipping <br />
                      (5 - 7 days)
                    </p>
                    {/* Heading */}
                    <p className="font-weight-bold mb-4">Payment Method:</p>
