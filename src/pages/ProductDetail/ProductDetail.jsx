...
export default function ProductDetail() {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              {/* Breadcrumb */}
              <ol className="breadcrumb font-size-xs mb-0 text-gray-400">
            ...
            <div className="col-12">
              <div className="row">
                <div className="col-12 col-md-6">
                  ...
                  {/* Slider */}
                  <div
                    className="flickity-nav mx-n2 mb-md-0 mb-10"
                ...
                <div className="col-12 col-md-6 pl-lg-10">
                  ...
                  <div className="mb-7">
                    ...
                    <span className="font-size-h5 font-weight-bolder text-primary ml-1">$85.00</span>
                  ...
                  <form>
                    ...
                    <div className="form-group">
                      ...
                      <p>
                        ...
                        <a className="text-reset text-decoration-underline" data-toggle="modal" href="#modalWaitList">
                          Join the Wait List!
                        </a>
                      </p>
                      {/* Share */}
                      ...
                      <div className="row">
                        <div className="col-12">
                          ...
                          <p className="text-gray-500">
                            Won&apos;t herb first male seas, beast. Let upon, female upon third fifth every. Man subdue
                            rule after years herb after form. And image may, morning. Behold in tree day sea that
                            together cattle whose. Fifth gathering brought bearing. Abundantly creeping whose. Beginning
      ...
      {/* REVIEWS */}
      <section className="pb-11 pt-9" id="reviews">
        <div className="container">
          <div className="row">
            <div className="col-12">
              {/* Heading */}
                ...
                <form>
                  <div className="row">
                    <div className="col-12 mb-6 text-center">
                      {/* Text */}
                      <p className="font-size-xs mb-1">Score:</p>
                      {/* Rating form */}
              ...
              <div className="row align-items-center">
                <div className="col-12 col-md-auto">
                  {/* Dropdown */}
                  <div className="dropdown mb-md-0 mb-4">
                    {/* Toggle */}
                ...
                <div className="col-12 col-md text-md-right">
                  {/* Rating */}
                  <div className="rating text-dark h6 mb-md-0 mb-4" data-value={4}>
                    <div className="rating-item">
                      <i className="fas fa-star" />
                    </div>
                    <div className="rating-item">
                ...
                <div className="review">
                  <div className="review-body">
                    <div className="row">
                      <div className="col-12 col-md-auto">
                        {/* Avatar */}
                        <div className="avatar avatar-xxl mb-md-0 mb-6">
                      ...
                      <div className="col-12 col-md">
                        ...
                        {/* Title */}
                        <p className="font-size-lg font-weight-bold mb-2">So cute!</p>
                        {/* Text */}
                        <p className="text-gray-500">
                          Justo ut diam erat hendrerit. Morbi porttitor, per eu. Sodales curabitur diam sociis. Taciti
                          lobortis nascetur. Ante laoreet odio hendrerit. Dictumst curabitur nascetur lectus potenti dis
                  ...
                  <div className="review-body">
                    <div className="row">
                      ...
                      <div className="col-12 col-md">
                        ...
                        {/* Title */}
                        <p className="font-size-lg font-weight-bold mb-2">Cute, but too small</p>
                        {/* Text */}
                        <p className="text-gray-500">
                          Shall good midst can&apos;t. Have fill own his multiply the divided. Thing great. Of heaven
                          whose signs.
                        </p>
                      </div>
                    </div>
