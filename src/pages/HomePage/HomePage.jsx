export default function HomePage() {
  return (
    <>
      {/* PROMO */}
      <div className="bg-dark bg-pattern mb-4 py-3">
      ...
      <section>
        <div className="row no-gutters d-block d-lg-flex flickity flickity-lg-none" data-flickity='{"watchCSS": true}'>
          ...
          >
            <div className="card bg-dark-5 bg-hover text-center text-white" style={{ minHeight: 470 }}>
              <div className="card-body mb-n11 mt-auto py-8">
                {/* Heading */}
                <h1 className="font-weight-bolder mb-0">Women</h1>
              </div>
          ...
          >
            <div className="card bg-dark-5 bg-hover text-center text-white" style={{ minHeight: 470 }}>
              <div className="card-body mb-n11 mt-auto py-8">
                {/* Heading */}
                <h1 className="font-weight-bolder mb-0">Men</h1>
              </div>
              <div className="card-body mt-auto py-8">
                {/* Button */}
                <a className="btn btn-white stretched-link" href="shop.html">
          ...
          >
            <div className="card bg-dark-5 bg-hover text-center text-white" style={{ minHeight: 470 }}>
              <div className="card-body mb-n11 mt-auto py-8">
                {/* Heading */}
                <h1 className="font-weight-bolder mb-0">Đồ chơi, Mẹ &amp; Bé</h1>
              </div>
              <div className="card-body mt-auto py-8">
                {/* Button */}
                <a className="btn btn-white stretched-link" href="shop.html">
      ...
      <section className="pt-7">
        <div className="container">
          <div className="row border-bottom pb-7">
            <div className="col-12 col-md-6 col-lg-3">
              {/* Item */}
              <div className="d-flex mb-lg-0 mb-6">
                {/* Icon */}
                ...
                <div className="ml-6">
                  ...
                  {/* Text */}
                  <p className="font-size-sm text-muted mb-0">From all orders over $100</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-3">
              ...
              <div className="d-flex mb-lg-0 mb-6">
                ...
                <div className="ml-6">
                  {/* Heading */}
                  <h6 className="heading-xxs mb-1">Free returns</h6>
                  {/* Text */}
                  <p className="font-size-sm text-muted mb-0">Return money within 30 days</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-3">
              {/* Item */}
              <div className="d-flex mb-md-0 mb-6">
                {/* Icon */}
                <i className="fe fe-lock font-size-lg text-primary" />
                {/* Body */}
                <div className="ml-6">
                  {/* Heading */}
                  <h6 className="heading-xxs mb-1">Secure shopping</h6>
                  {/* Text */}
                  <p className="font-size-sm text-muted mb-0">You&apos;re in safe hands</p>
                </div>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-3">
              ...
              <div className="d-flex">
                ...
                <div className="ml-6">
                  {/* Heading */}
                  <h6 className="heading-xxs mb-1">Over 10,000 Styles</h6>
                  {/* Text */}
                  <p className="font-size-sm text-muted mb-0">We have everything you need</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
              ...
              <p className="mb-10 text-gray-500">
                Appear, dry there darkness they&apos;re seas, dry waters thing fly midst. Beast, above fly brought Very
                green.
              </p>
            </div>
          </div>
          <div className="row">
            <div className="col-12 col-md-5 col-lg-4 d-flex flex-column">
              ...
              <div
                ...
                style={{ minHeight: 400, backgroundImage: 'url(./img/products/product-1.jpg)' }}
              >
                {/* Background */}
            ...
            <div className="col-12 col-md-7 col-lg-8 d-flex flex-column">
              {/* Card */}
              <div className="product-card card text-body mb-7" style={{ minHeight: 400 }}>
                {/* Background */}
                <div className="card-bg">
                  <div
                    className="card-bg-img bg-cover"
                ...
                {/* Body */}
                <div className="card-body px-md-10 text-md-left my-auto text-center">
                  {/* Circle */}
                  ...
                  {/* Link */}
                  <a className="btn btn-link stretched-link text-reset px-0" href="shop.html">
                    Shop Now <i className="fe fe-arrow-right ml-2" />
                  </a>
                </div>
              </div>
            ...
            <div className="col-12 col-md-7 col-lg-8 d-flex flex-column">
              {/* Card */}
              <div className="product-card card mb-md-0 text-body mb-7" style={{ minHeight: 400 }}>
                {/* Background */}
                <div className="card-bg">
                  <div
                    className="card-bg-img bg-cover"
                    ...
                    <div className="card-body">
                      ...
                      <blockquote className="mb-0">
                        <p className="text-muted">
                          From creepeth said moved given divide make multiply of him shall itself also above second
                          doesn&apos;t unto created saying land herb sea midst night wherein.
                        </p>
                ...
                <div className="col-12 col-sm-8 col-md-6 col-lg-4">
                  ...
                  <div className="card-lg card border">
                    <div className="card-body">
                      ...
                      <blockquote className="mb-0">
                        <p className="text-muted">
                          God every fill great replenish darkness unto. Very open. Likeness their that light. Given
                          under image to. Subdue of shall cattle day fish form saw spirit and given stars, us you whales
                ...
                <div className="col-12 col-sm-8 col-md-6 col-lg-4">
                  ...
                  <div className="card-lg card border">
                    <div className="card-body">
                      ...
                      <blockquote className="mb-0">
                        <p className="text-muted">
                          Fill his waters wherein signs likeness waters. Second light gathered appear sixth fourth,
                  ...
                  <div className="card-lg card border">
                    <div className="card-body">
                      ...
                      <blockquote className="mb-0">
                        <p className="text-muted">
                          God every fill great replenish darkness unto. Very open. Likeness their that light. Given
                          under image to. Subdue of shall cattle day fish form saw spirit and given stars.
                        </p>
                        <footer className="font-size-xs text-muted">
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              ...
              {/* Subheading */}
              <p className="font-size-lg mb-10 text-gray-500">
            ...
            <div className="col-6 col-sm-4 col-md px-1">
              ...
              <div className="card mb-2">
                ...
                <a
                  ...
                  href="blog-post.html"
                >
                  <p className="font-size-xxs my-0 text-center text-white">
                    <i className="fe fe-heart mr-2" /> 248 <i className="fe fe-message-square ml-3 mr-2" /> 7
                  </p>
                </a>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-4 col-sm-3 col-md text-center">
              {/* Brand */}
              <img src="./img/brands/gray-350/mango.svg" alt="..." className="img-fluid mb-md-0 mb-7" />
            </div>
            <div className="col-4 col-sm-3 col-md text-center">
              {/* Brand */}
              <img src="./img/brands/gray-350/zara.svg" alt="..." className="img-fluid mb-md-0 mb-7" />
            </div>
            <div className="col-4 col-sm-3 col-md text-center">
              {/* Brand */}
              <img src="./img/brands/gray-350/reebok.svg" alt="..." className="img-fluid mb-md-0 mb-7" />
            </div>
            <div className="col-4 col-sm-3 col-md text-center">
              {/* Brand */}
              <img src="./img/brands/gray-350/asos.svg" alt="..." className="img-fluid mb-md-0 mb-7" />
            </div>
            <div className="col-4 col-sm-3 col-md text-center">
              {/* Brand */}
              <img src="./img/brands/gray-350/stradivarius.svg" alt="..." className="img-fluid mb-sm-0 mb-6" />
            </div>
            <div className="col-4 col-sm-3 col-md text-center">
              {/* Brand */}
              <img src="./img/brands/gray-350/adidas.svg" alt="..." className="img-fluid mb-sm-0 mb-6" />
            </div>
            <div className="col-4 col-sm-3 col-md text-center">
              {/* Brand */}
