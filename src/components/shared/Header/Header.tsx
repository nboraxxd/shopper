...
import { ActionLink, Theme } from '@/components/shared/Header'
...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="background-light1_dark1 md:background-light3_dark1 shadow1_dark-shadow0 fixed inset-x-0 top-0 z-20 h-[82px] flex-center lg:h-[90px]">
        <div className="container flex-center">
          {/* Open sidebar button */}
          <PrimaryButton
            className="shadow1_dark-shadow0 rounded-md py-2.5 pl-0.5 pr-2.5 hover:bg-light-2/50 dark:hover:bg-dark-2/15 md:mr-6 lg:hidden"
          ...
          <div className="gap-5 flex-center md:ml-auto">
            {/* Search */}
            <PrimaryButton className="md:background-light1_dark2 shadow1_dark-shadow0 rounded-md p-2.5 hover:bg-light-2/50 dark:hover:bg-dark-2/15 md:hover:bg-light-1/70 dark:md:hover:bg-dark-3/15 lg:rounded-lg lg:p-3.5">
              <img src="/assets/icons/search.svg" alt="Search" className="icon-filter h-6 w-6" />
            </PrimaryButton>

            <div className="background-light1_dark2 shadow1_dark-shadow0 rounded-md flex-center max-md:hidden lg:rounded-lg">
              {/* Favorites */}
