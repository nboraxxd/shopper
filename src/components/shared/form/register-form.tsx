...
import { useRegister, useResendEmail } from '@/lib/react-query'
  ...
  return (
    <>
      ...
      >
        ...
        {registerMutation.isSuccess ? (
          <CountdownButton
            className="mt-5 h-12 rounded-xl bg-primary-yellow px-5 text-medium-18 text-secondary-1 transition-opacity hover:opacity-85 disabled:bg-primary-yellow/50 disabled:opacity-100"
            type="button"
            timer={60}
          ...
          <ButtonWithLoading
            buttonClassName="mt-5 h-12 rounded-xl bg-primary-yellow px-5 text-medium-18 text-secondary-1 transition-opacity hover:opacity-85"
