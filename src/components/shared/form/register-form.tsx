  ...
  return (
    <>
      ...
      >
        ...
        {registerMutation.isSuccess ? (
          <CountdownButton
            className="medium-18 mt-5 h-12 rounded-xl bg-primary-yellow px-5 text-secondary-1 transition-opacity hover:opacity-85 disabled:bg-primary-yellow/50 disabled:opacity-100"
            type="button"
            timer={60}
          ...
          <ButtonWithLoading
            buttonClassName="medium-18 mt-5 h-12 rounded-xl bg-primary-yellow px-5 text-secondary-1 transition-opacity hover:opacity-85"
