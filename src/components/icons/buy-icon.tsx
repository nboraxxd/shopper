export default function BuyIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.15435 20.2031C7.45535 20.2031 7.69835 20.4471 7.69835 20.7471C7.69835 21.0481 7.45535 21.2921 7.15435 21.2921C6.85335 21.2921 6.61035 21.0481 6.61035 20.7471C6.61035 20.4471 6.85335 20.2031 7.15435 20.2031Z"
        className="fill-[#1A162E] stroke-[#1A162E] dark:fill-white dark:stroke-white"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
