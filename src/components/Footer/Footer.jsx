        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-12 col-md-3">
              ...
              {/* Social */}
              <ul className="list-unstyled list-inline mb-md-0 mb-7">
            ...
            <div className="col-6 col-sm">
              ...
              {/* Links */}
              <ul className="list-unstyled mb-sm-0 mb-7">
                <li>
      ...
      <div className="py-6">
        <div className="container">
          <div className="row">
            <div className="col">
              {/* Copyright */}
              <p className="mb-md-0 font-size-xxs text-muted mb-3">© 2019 All rights reserved. Designed by Unvab.</p>
            </div>
            <div className="col-auto">
              {/* Payment methods */}
