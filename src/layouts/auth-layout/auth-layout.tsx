  ...
  return (
    <main className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="background-secondary6_dark1 hidden flex-col items-center justify-center gap-12 px-7 lg:flex">
        ...
        <p className="text-secondary1_dark3 max-w-[412px] text-center text-medium-18">
      ...
      <div className="background-light1_dark2 px-5 sm:px-7">
        <div className="flex-center mx-auto w-[min(460px,100%)] flex-col justify-center py-14 text-center">
          <Logo
            BrandTag="h2"
